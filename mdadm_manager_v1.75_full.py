...
class MdadmManager(tk.Tk):
    ...
    def dashboard_cable_sata_assistant(self):
        ...
        if not array_path or not dev.startswith("/dev/"):
            messagebox.showwarning(
                title,
                "Unable to identify the selected RAID member."
                if english else
                "Impossible d'identifier le membre RAID sélectionné."
            )
            return
